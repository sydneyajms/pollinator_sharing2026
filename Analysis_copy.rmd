...
Make a null model to determine how different the actual treatment overlaps differ from random community assembly. If they are very different, then we could infer the overlap is a result of the plant community. 
...
ggplot(WIDEfocalSeeds) +
  geom_boxplot(aes(x = genSpec, y = AVoverlap, fill = genSpec)) +
