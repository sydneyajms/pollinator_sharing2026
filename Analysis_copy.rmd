...
```
Hypothesis 1 = visitation against overlap and seed output 
...
ggplot(HypothOne) +
  geom_point(aes(x = total_visits, y = diff, color = treatment))

ggplot(HypothOne) +
    geom_point(aes(x = total_visits, y = partner_diversity, color = treatment))
